    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container-fluid">
                <a className="navbar-brand" href="#">La Visual</a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <a className="nav-link active" aria-current="register" href="#">Registrarse</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link active" aria-current="login" href="#">Iniciar Sesión</a>
                        </li>
                    </ul>
                </div>
            </div>
